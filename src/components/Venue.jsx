...
const venueList = [
  { id: 1, name: "Schönbrunn Palace" },
  { id: 2, name: "St. Stephen’s Cathedral (Stephansdom)" },
  { id: 3, name: "Hofburg Palace" },
  { id: 4, name: "Belvedere Palace" },
  { id: 5, name: "Vienna State Opera (Wiener Staatsoper)" },
  { id: 6, name: "Prater & Giant Ferris Wheel" },
...
const Venue = () => {
  return (
    <div className="w-full py-8 px-4 md:px-12 flex flex-col justify-center items-center md:px-32 border-t">
      ...
      {/* CTA Button */}
      <a href="/venue">
        <button className="bg-one px-10 md:px-20 py-2 rounded-full mt-6 text-sm md:text-base hover:bg-one transition text-white">
          View All
        </button>
      </a>
    </div>
