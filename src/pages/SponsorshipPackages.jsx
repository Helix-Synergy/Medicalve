...
const SponsorshipPackages = () => {
  return (
    <div className="w-full 2xl:max-w-[1280px] mx-auto justify-center items-center text-center lg:mb-12">
      <div className={`${banner_style} sponsors_package`}>
        <h1 className="text-slate-100 text-3xl sm:text-5xl md:text-6xl font-bold px-4">
          Sponsorship Packages
        </h1>{" "}
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:px-16 py-8">
        {sponsorshipPackages.map((pkg) => (
          ...
          >
            ...
            <Link to="https://helixconferences.com/buy-a-ticket" target="_blank" rel="noopener noreferrer">
      ...
      <div className="my-12 md:px-32 px-4">
        {last_item.map((pkg) => (
          <div
            key={pkg.type}
            className="border border-gray-200 rounded-2xl shadow-md p-4 bg-white items-center flex flex-col justify-between"
